namespace WebApi.Exceptions
{
    public static class ExceptionFields
    {
        ...
        public const string InvalidOrderItemQuantity = "InvalidOrderItemQuantity";
        public const string InvalidOrderItemPrice = "InvalidOrderItemPrice";
        public const string InvalidTotalOrderPrice = "InvalidTotalOrderPrice";
    }
}